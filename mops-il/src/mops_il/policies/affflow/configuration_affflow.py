...
@PreTrainedConfig.register_subclass("affflow")
@dataclass
class AffFlowConfig(PreTrainedConfig):
    ...
    tokenizer_name: str = "google/t5-v1_1-small"
    # vocab_size is not needed for pretrained CLIP
    tokenizer_max_length: int = 77  # CLIP default max length
    text_embedding_dim: int = 512  # CLIP ViT-B/32 output dim & T5-small d_model
