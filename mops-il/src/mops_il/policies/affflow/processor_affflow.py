...
from ..factory import register_processor_fn
from .configuration_affflow import AffFlowConfig


@register_processor_fn(policy_type="affflow")
def make_affflow_pre_post_processors(
    ...
    """Constructs pre-processor and post-processor pipelines for an AffFlow policy.
