...
def transitions_stream(
    shutdown_event: Event, transitions_queue: Queue, timeout: float
) -> services_pb2.Empty:  # type: ignore
...
def push_transitions_to_transport_queue(transitions: list, transitions_queue) -> None:
