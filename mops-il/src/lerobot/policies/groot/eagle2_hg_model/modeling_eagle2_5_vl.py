...
class Eagle25VLForConditionalGeneration(Eagle25VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(
        self, config: Eagle25VLConfig, vision_model=None, language_model=None
    ) -> None:
    ...
    def wrap_backbone_lora(self, r=128, lora_alpha=256, lora_dropout=0.05) -> None:
    ...
    def wrap_llm_lora(self, r=128, lora_alpha=256, lora_dropout=0.05) -> None:
        lora_config = LoraConfig(
            r=r,
            target_modules=[
                "self_attn.q_proj",
