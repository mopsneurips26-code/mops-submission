...
class CategorySpecificLinear(nn.Module):
    def __init__(self, num_categories, input_dim, hidden_dim) -> None:
        super().__init__()
...
class CategorySpecificMLP(nn.Module):
    def __init__(self, num_categories, input_dim, hidden_dim, output_dim) -> None:
        super().__init__()
        self.num_categories = num_categories
...
class MultiEmbodimentActionEncoder(nn.Module):
    def __init__(self, action_dim, hidden_size, num_embodiments) -> None:
        super().__init__()
