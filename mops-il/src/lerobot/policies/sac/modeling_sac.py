...
class SACPolicy(
    ...
    def _init_encoders(self) -> None:
        ...
        self.encoder_actor = (
            ...
            else SACObservationEncoder(self.config)
        )

    def _init_critics(self, continuous_action_dim) -> None:
    ...
    def _init_actor(self, continuous_action_dim) -> None:
...
def freeze_image_encoder(image_encoder: nn.Module) -> None:
...
class SpatialLearnedEmbeddings(nn.Module):
    def __init__(self, height, width, channel, num_features=8) -> None:
...
class RescaleFromTanh(Transform):
    def __init__(self, low: float = -1, high: float = 1) -> None:
        super().__init__()
...
class TanhMultivariateNormalDiag(TransformedDistribution):
    def __init__(self, loc, scale_diag, low=None, high=None) -> None:
