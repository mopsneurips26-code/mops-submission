...
class CabinetPanel(MujocoXMLObject):
    ...
    @abc.abstractmethod
    def _get_components(self) -> Never:
    ...
    def _set_texture(self) -> None:
        ...
        material.set("name", f"{self.name}_mat")
        material.set("texture", tex_name)

    def _add_handle(self) -> None:
...
class ShakerCabinetPanel(CabinetPanel):
    ...
    def __init__(self, name, trim_th=0.02, trim_size=0.08, *args, **kwargs) -> None:
