...
class Handle(MujocoXMLObject):
    ...
    @abc.abstractmethod
    def _create_handle(self, positions, sizes) -> Never:
        raise NotImplementedError
...
class BoxedHandle(Handle):
    ...
    def __init__(self, length=0.24, handle_pad=0.04, *args, **kwargs) -> None:
        self.handle_pad = handle_pad
        super().__init__(
...
class KnobHandle(Handle):
    ...
    def __init__(self, handle_pad=0.07, *args, **kwargs) -> None:
        super().__init__(
