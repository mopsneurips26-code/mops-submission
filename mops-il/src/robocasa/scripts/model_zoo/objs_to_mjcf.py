...
def merge_xmls(xmls, model_name, save_path) -> None:
    # Load XML tree
    et = ET.parse(
        os.path.join(
...
def generate_xml_from_objs(model_dir, primary, model_name, rot, verbose) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        type=str,
        help="(optional) name of saved mjcf model. Defaults to primary .obj file name",
    )
    parser.add_argument(
        "--primary",
        required=False,
