...
def check_env_version(env, env_meta) -> None:
...
def create_env(
    ...
    **kwargs,
    ...
    print(f"Created environment with name {env_name}")
    print(f"Action size is {env.action_dimension}")
    return env
