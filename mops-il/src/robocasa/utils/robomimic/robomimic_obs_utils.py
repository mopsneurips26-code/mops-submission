...
def register_obs_key(target_class) -> None:
...
def register_encoder_core(target_class) -> None:
...
def register_randomizer(target_class) -> None:
...
def obs_encoder_kwargs_from_config(obs_encoder_config):
    ...
    for _obs_modality, encoder_kwargs in obs_encoder_config.items():
...
def initialize_obs_modality_mapping_from_dict(modality_mapping) -> None:
    ...
    for mod, keys in modality_mapping.items():
        ...
        OBS_KEYS_TO_MODALITIES.update(dict.fromkeys(keys, mod))


def initialize_obs_utils_with_obs_specs(obs_modality_specs) -> None:
    ...
    for obs_modality, obs_keys in OBS_MODALITIES_TO_KEYS.items():
        print(f"using obs modality: {obs_modality} with keys: {obs_keys}")


def initialize_default_obs_encoder(obs_encoder_config) -> None:
...
def initialize_obs_utils_with_config(config) -> None:
...
def has_modality(modality, obs_keys) -> bool:
    ...
    """
    return any(key_is_obs_modality(k, obs_modality=modality) for k in obs_keys)
...
class Modality:
    ...
    @classmethod
    def set_obs_processor(cls, processor=None) -> None:
    ...
    @classmethod
    def set_obs_unprocessor(cls, unprocessor=None) -> None:
    ...
    @classmethod
    def _default_obs_processor(cls, obs) -> Never:
    ...
    @classmethod
    def _default_obs_unprocessor(cls, obs) -> Never:
