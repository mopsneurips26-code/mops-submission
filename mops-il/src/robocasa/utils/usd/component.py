...
class USDMesh:
    ...
    def _attach_material(self) -> None:
    ...
    def update(
        self, pos: np.ndarray, mat: np.ndarray, visible: bool, frame: int
    ) -> None:
    ...
    def update_visibility(self, visible: bool, frame: int) -> None:
        if visible:
...
class USDPrimitiveMesh:
    ...
    def _set_refinement_properties(self) -> None:
...
class USDDomeLight:
    ...
    def update(self, intensity: int, color: np.ndarray, frame: int) -> None:
        self.usd_light.GetIntensityAttr().Set(intensity)
...
class USDCamera:
    ...
    def update(self, cam_pos: np.ndarray, cam_mat: np.ndarray, frame: int) -> None:
        transformation_mat = utils_component.create_transform_matrix(
