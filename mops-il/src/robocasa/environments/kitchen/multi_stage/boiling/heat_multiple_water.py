...
class HeatMultipleWater(Kitchen):
    ...
    def __init__(self, init_robot_base_pos="stove", *args, **kwargs) -> None:
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.ref_cab = self.register_fixture_ref(
            "cab", {"id": FixtureType.CABINET_TOP, "ref": self.stove}
        )
        self.ref_counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "ref": self.ref_cab, "size": (0.2, 0.2)},
        )
