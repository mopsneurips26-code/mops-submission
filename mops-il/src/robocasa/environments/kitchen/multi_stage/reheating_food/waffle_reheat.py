...
class WaffleReheat(Kitchen):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.microwave = self.register_fixture_ref(
            "microwave", {"id": FixtureType.MICROWAVE}
        )
        self.counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "size": (0.6, 0.6), "ref": self.microwave},
        )
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = (
            "Open the microwave, place the bowl with waffle inside the microwave, "
