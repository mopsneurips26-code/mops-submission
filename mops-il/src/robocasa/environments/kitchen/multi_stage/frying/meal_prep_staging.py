...
class MealPrepStaging(Kitchen):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "ref": self.stove, "size": (0.3, 0.2)},
        )
        ...
        cfgs.append(
            {
                ...
                "placement": {
                    ...
                    "sample_region_kwargs": {"ref": self.stove, "loc": "left_right"},
                    "size": (0.5, 0.05),
                    "pos": ("ref", 0.2),
                    "offset": (-0.13, 0.0),
                    "rotation": 0,
    ...
    def _check_success(self):
        ...
        pans_on_stove = pan1_loc is not None and pan2_loc is not None
