...
class SteamVegetables(Kitchen):
    ...
    def __init__(self, knob_id="random", *args, **kwargs) -> None:
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.counter = self.register_fixture_ref(
            "counter", {"id": FixtureType.COUNTER, "ref": FixtureType.STOVE}
        )
    ...
    def _check_success(self):
        ...
        pot_on_stove = OU.check_obj_fixture_contact(self, "pot", self.stove)
