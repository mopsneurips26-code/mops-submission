...
class PnP(Kitchen):
    ...
    def __init__(
        self, obj_groups="all", exclude_obj_groups=None, *args, **kwargs
    ) -> None:
...
class PnPCounterToCab(PnP):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.counter = self.register_fixture_ref(
            "counter", {"id": FixtureType.COUNTER, "ref": self.cab}
        )
...
class PnPCabToCounter(PnP):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "ref": self.cab},
        )
        self.init_robot_base_pos = self.cab
...
class PnPCounterToSink(PnP):
    ...
    def __init__(self, obj_groups="all", *args, **kwargs) -> None:
        super().__init__(obj_groups=obj_groups, *args, **kwargs)
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "ref": self.sink},
        )
...
class PnPSinkToCounter(PnP):
    ...
    def __init__(self, obj_groups="food", *args, **kwargs) -> None:
        super().__init__(obj_groups=obj_groups, *args, **kwargs)
...
class PnPCounterToMicrowave(PnP):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "ref": self.microwave},
        )
...
class PnPCounterToStove(PnP):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        """
        super()._setup_kitchen_references()
        self.stove = self.register_fixture_ref("stove", {"id": FixtureType.STOVE})
        self.counter = self.register_fixture_ref(
            "counter",
            {"id": FixtureType.COUNTER, "ref": self.stove, "size": [0.30, 0.40]},
        )
