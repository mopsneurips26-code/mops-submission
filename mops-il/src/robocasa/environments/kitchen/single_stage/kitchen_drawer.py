...
class ManipulateDrawer(Kitchen):
    ...
    def _setup_kitchen_references(self) -> None:
        ...
        self.drawer = self.register_fixture_ref("drawer", {"id": self.drawer_id})
    ...
    def check_fxtr_contact(self, pos) -> bool:
        ...
        fxtrs = [
            ...
            if isinstance(
                fxtr,
                (Counter, Stove, Stovetop, HousingCabinet, SingleCabinet, HingeCabinet),
            )
        ]
    ...
    def check_sidewall_contact(self, pos) -> bool:
        ...
        for joint_p in door_state.values():
            if self.behavior == "open":
                if joint_p < 0.95:
                    success = False
                    break
            elif self.behavior == "close" and joint_p > 0.05:
                success = False
                break
            ...
            cfgs.append(
                {
                    ...
                    "placement": {
                        "fixture": self.get_fixture(
                            FixtureType.COUNTER, ref=self.drawer
                        ),
