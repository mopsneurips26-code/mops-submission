...
class DataCollectionWrapper(Wrapper):
    def __init__(self, env, directory, collect_freq=1, flush_freq=100) -> None:
        ...
        if not os.path.exists(directory):
            print(f"DataCollectionWrapper: making new directory at {directory}")
    ...
    def _on_first_interaction(self) -> None:
