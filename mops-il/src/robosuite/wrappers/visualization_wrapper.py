...
class VisualizationWrapper(Wrapper):
    def __init__(self, env, indicator_configs=None) -> None:
        ...
        self._vis_settings = dict.fromkeys(self.env._visualizations, True)
    ...
    def set_indicator_pos(self, indicator, pos) -> None:
        ...
        assert indicator in indicator_names, (
            f"Invalid indicator name specified. Valid options are {indicator_names}, got {indicator}"
        )
    ...
    def set_visualization_setting(self, setting, visible) -> None:
        ...
        """
        assert setting in self._vis_settings, (
            f"Invalid visualization setting specified. Valid options are {self._vis_settings.keys()}, got {setting}"
        )
