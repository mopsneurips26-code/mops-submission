...
class USDSphereLight:
    ...
    def __init__(
        self, stage: Usd.Stage, light_name: str, radius: float | None = 0.3
    ) -> None:
        self.stage = stage
...
class USDDomeLight:
    ...
    def __init__(self, stage: Usd.Stage, light_name: str) -> None:
        self.stage = stage
    ...
    def update(self, intensity: int, color: np.ndarray) -> None:
...
class USDRectLight:
    ...
    def __init__(
        self, stage: Usd.Stage, light_name: str, width: float, height: float
    ) -> None:
        self.stage = stage
...
class USDCylinderLight:
    ...
    def __init__(
        self, stage: Usd.Stage, light_name: str, length: float, radius: float
    ) -> None:
        self.stage = stage
