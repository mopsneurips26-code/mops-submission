...
def get_triangle_uvs(
    ...
    texture_type: mujoco.mjtTexture | None,
):
...
class TriangleMesh:
    ...
    def __init__(
        self, vertices: np.ndarray, triangles: np.ndarray, triangle_uvs: np.ndarray
    ) -> None:
    ...
    @classmethod
    def create_sphere(
        cls, radius: float, texture_type: mujoco.mjtTexture | None, resolution: int
    ) -> "TriangleMesh":
        """Creates a sphere."""
        vertices = []
        triangles = []
