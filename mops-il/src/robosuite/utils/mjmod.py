...
class BaseModder:
    ...
    def __init__(self, sim, random_state=None) -> None:
        self.sim = sim
...
class LightingModder(BaseModder):
    ...
    def _randomize_position(self, name) -> None:
    ...
    def _randomize_direction(self, name) -> None:
    ...
    def _randomize_specular(self, name) -> None:
    ...
    def _randomize_ambient(self, name) -> None:
    ...
    def _randomize_diffuse(self, name) -> None:
    ...
    def _randomize_active(self, name) -> None:
    ...
    def get_pos(self, name):
        ...
        assert lightid > -1, f"Unkwnown light {name}"

        return self.model.light_pos[lightid]

    def set_pos(self, name, value) -> None:
        ...
        value = list(value)
        assert len(value) == 3, f"Expected 3-dim value, got {value}"
    ...
    def set_dir(self, name, value) -> None:
    ...
    def set_active(self, name, value) -> None:
    ...
    def set_specular(self, name, value) -> None:
    ...
    def set_ambient(self, name, value) -> None:
    ...
    def set_diffuse(self, name, value) -> None:
...
class CameraModder(BaseModder):
    ...
    def _randomize_rotation(self, name) -> None:
    ...
    def _randomize_fovy(self, name) -> None:
    ...
    def get_fovy(self, name):
        ...
        assert camid > -1, f"Unknown camera {name}"
        return self.model.cam_fovy[camid]

    def set_fovy(self, name, value) -> None:
    ...
    def set_quat(self, name, value) -> None:
        ...
        """
        value = list(value)
        assert len(value) == 4, f"Expectd value of length 4, instead got {value}"
        camid = self.get_camid(name)
        assert camid > -1, f"Unknown camera {name}"
    ...
    def set_pos(self, name, value) -> None:
        ...
        """
        value = list(value)
        assert len(value) == 3, f"Expected value of length 3, instead got {value}"
        camid = self.get_camid(name)
        assert camid > -1
...
class TextureModder(BaseModder):
    ...
    def _randomize_geom_color(self, name) -> None:
    ...
    def _randomize_texture(self, name) -> None:
    ...
    def _randomize_material(self, name) -> None:
    ...
    def rand_checker(self, name) -> None:
    ...
    def rand_gradient(self, name) -> None:
    ...
    def whiten_materials(self) -> None:
    ...
    def set_geom_rgb(self, name, rgb) -> None:
    ...
    def set_texture(self, name, bitmap, perturb=False) -> None:
    ...
    def set_material(self, name, material, perturb=False) -> None:
    ...
    def set_checker(self, name, rgb1, rgb2, perturb=False) -> None:
    ...
    def set_gradient(self, name, rgb1, rgb2, vertical=True, perturb=False) -> None:
    ...
    def set_rgb(self, name, rgb, perturb=False) -> None:
    ...
    def set_noise(self, name, rgb1, rgb2, fraction=0.9, perturb=False) -> None:
    ...
    def upload_texture(self, name, device_id=0) -> None:
    ...
    def _check_geom_for_texture(self, name) -> bool:
...
class Texture:
    ...
    def __init__(self, model, tex_id) -> None:
        self.id = tex_id
...
class DynamicsModder(BaseModder):
    ...
    def mod(self, name, attr, val) -> None:
        ...
        assert attr in self.dynamics_parameters, (
            f"Invalid dynamics parameter specified! Supported parameters are: {self.dynamics_parameters};"
            f" requested: {attr}"
        )
    ...
    def mod_density(self, name=None, val=0.0) -> None:
    ...
    def mod_viscosity(self, name=None, val=0.0) -> None:
    ...
    def mod_position(self, name, val=(0, 0, 0)) -> None:
    ...
    def mod_quaternion(self, name, val=(1, 0, 0, 0)) -> None:
    ...
    def mod_inertia(self, name, val) -> None:
    ...
    def mod_mass(self, name, val) -> None:
    ...
    def mod_friction(self, name, val) -> None:
    ...
    def mod_solref(self, name, val) -> None:
    ...
    def mod_solimp(self, name, val) -> None:
    ...
    def mod_stiffness(self, name, val) -> None:
    ...
    def mod_frictionloss(self, name, val) -> None:
    ...
    def mod_damping(self, name, val) -> None:
    ...
    def mod_armature(self, name, val) -> None:
