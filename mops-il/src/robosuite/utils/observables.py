...
class Observable:
    ...
    def update(self, timestep, obs_cache, force=False) -> None:
    ...
    def set_corrupter(self, corrupter) -> None:
    ...
    def set_delayer(self, delayer) -> None:
    ...
    def _check_sensor_validity(self) -> None:
        ...
        try:
            ...
            raise ValueError(f"Current sensor for observable {self.name} is invalid.")
