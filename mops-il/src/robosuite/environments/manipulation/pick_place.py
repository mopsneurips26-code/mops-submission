...
class PickPlace(ManipulationEnv):
    ...
    def __init__(
        ...
        if object_type is not None:
            assert object_type in self.object_to_id, (
                f"invalid @object_type argument - choose one of {list(self.object_to_id.keys())}"
            )
    ...
    def _construct_visual_objects(self) -> None:
    ...
    def _construct_objects(self) -> None:
        """Function that can be overriden by subclasses to load different objects."""
        self.objects = []
