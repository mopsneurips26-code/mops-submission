...
if mujoco.__version__ == "3.1.1" and np.__version__[0] == "2":
    ROBOSUITE_DEFAULT_LOGGER.warning(
        "If using mujoco==3.1.1, please use numpy < 2 for rendering with USD."
    )
...
if __name__ == "__main__":
    ...
    if args.device == "keyboard":
        ...
        raise Exception(
            "Invalid device choice: choose either 'keyboard' or 'spacemouse' or 'dualsense'."
        )
    ...
    exp.add_light(
        pos=[0, 0, 0], intensity=2000, obj_name="dome_light", light_type="dome"
    )
