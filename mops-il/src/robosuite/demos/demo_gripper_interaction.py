    ...
    while True:
        if step % 100 == 0:
            ...
            for contact in sim.data.contact[0 : sim.data.ncon]:
                ...
                print(f"geom1: {geom_name1}, geom2: {geom_name2}")
                print(f"contact id {id(contact)}")
                print(f"friction: {contact.friction}")
                print(f"normal: {contact.frame[0:3]}")
        ...
        if step % T == 0:
            ...
            print(
                f"changing plan: gripper low: {gripper_z_is_low}, gripper closed {gripper_is_closed}"
            )
