...
class MobileRobot(Robot):
    ...
    def _load_base_controller(self) -> None:
        ...
        if self.part_controller_config.get(self.base) is None:
            controller_path = os.path.join(
                ...
                "..",
                f"controllers/config/{self.robot_model.default_controller_config[self.base]}.json",
            )
            ...
            assert type(self.part_controller_config[self.base]) == dict, (
                f"Inputted controller config must be a dict! Instead, got type: {type(self.part_controller_config[self.base])}"
            )
        ...
        self.part_controller_config[self.base]["naming_prefix"] = (
    ...
    def _load_torso_controller(self) -> None:
        ...
        if self.part_controller_config.get(self.torso) is None:
            controller_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                f"controllers/config/{self.robot_model.default_controller_config[self.torso]}.json",
            )
            ...
            #             NOTE: "type" must be one of: {JOINT_POSITION, JOINT_TORQUE, JOINT_VELOCITY,
            #                                           OSC_POSITION, OSC_POSE, IK_POSE}
            assert type(self.part_controller_config[self.torso]) == dict, (
                f"Inputted controller config must be a dict! Instead, got type: {type(self.part_controller_config[self.torso])}"
            )
        ...
        self.part_controller_config[self.torso]["naming_prefix"] = (
    ...
    def _load_head_controller(self) -> None:
        ...
        if self.part_controller_config.get(self.head) is None:
            controller_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                f"controllers/config/{self.robot_model.default_controller_config[self.head]}.json",
            )
            ...
            #             NOTE: "type" must be one of: {JOINT_POSITION, JOINT_TORQUE, JOINT_VELOCITY,
            #                                           OSC_POSITION, OSC_POSE, IK_POSE}
            assert type(self.part_controller_config[self.head]) == dict, (
                f"Inputted controller config must be a dict! Instead, got type: {type(self.part_controller_config[self.head])}"
            )
        ...
        self.part_controller_config[self.head]["naming_prefix"] = (
            self.robot_model.naming_prefix
        )
    ...
    def setup_references(self) -> None:
        ...
        for arm in self.arms:
            ...
            if self.has_gripper[arm]:
                ...
                self._ref_actuators_indexes_dict[self.get_gripper_name(arm)] = (
                    self._ref_joint_gripper_actuator_indexes[arm]
                )
