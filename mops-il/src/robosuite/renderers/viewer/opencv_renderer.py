...
class OpenCVViewer:
    ...
    def set_camera(
        self, camera_id=None, camera_name=None, width=None, height=None
    ) -> None:
        ...
        if camera_id is not None:
            if isinstance(camera_id, int):
                camera_id = [camera_id]
            self.camera_names = [
                self.sim.model.camera_id2name(cam_id) for cam_id in camera_id
            ]
        else:
    ...
    def render(self) -> None:
        ...
        im = [
            self.sim.render(camera_name=cam_name, height=self.height, width=self.width)[
                ..., ::-1
            ]
