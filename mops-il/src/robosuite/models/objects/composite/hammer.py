...
class HammerObject(CompositeObject):
    ...
    def _get_geom_attrs(self):
        ...
        assert self.handle_shape in {
            ...
            f"Error loading hammer: Handle type must either be 'box' or 'cylinder', got {self.handle_shape}."
        )
        add_to_dict(
            dic=obj_args,
