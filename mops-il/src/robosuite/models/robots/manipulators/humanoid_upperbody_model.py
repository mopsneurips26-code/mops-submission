...
class HumanoidUpperBodyModel(RobotModel):
    ...
    def add_gripper(self, gripper, arm_name=None) -> None:
    ...
    @property
    def default_gripper(self) -> Never:
    ...
    @property
    def base_xpos_offset(self) -> Never:
