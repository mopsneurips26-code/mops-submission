...
class ManipulatorModel(RobotModel):
    ...
    def add_gripper(self, gripper: GripperModel, arm_name: str | None = None) -> None:
        ...
        """
        if arm_name is None:
            assert isinstance(self.eef_name, dict), (
                "only support single insertion of gripper now"
            )
    ...
    @property
    def models(self) -> list[GripperModel | RobotModel]:
    ...
    @property
    def base_xpos_offset(self) -> dict[str, tuple | dict]:
    ...
    @property
    def _horizontal_radius(self) -> Never:
        raise NotImplementedError

    @property
    def default_base(self) -> Never:
        raise NotImplementedError

    @property
    def default_controller_config(self) -> Never:
        raise NotImplementedError

    @property
    def init_qpos(self) -> Never:
        raise NotImplementedError

    @property
    def init_base_qpos(self) -> None:
        return None

    @property
    def init_torso_qpos(self) -> None:
        return None
