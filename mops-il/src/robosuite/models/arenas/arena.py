...
class Arena(MujocoXML):
    ...
    def __init__(self, fname) -> None:
        ...
        recolor_collision_geoms(
            ...
            exclude=lambda e: e.get("name", None) == "floor",
        )

    def set_origin(self, offset) -> None:
    ...
    def set_camera(self, camera_name, pos, quat, camera_attribs=None) -> None:
    ...
    def _postprocess_arena(self) -> None:
        """Runs any necessary post-processing on the imported Arena model."""
        pass

    def set_scale(self, scale: float | list[float], obj_name: str) -> None:
