...
class MujocoXML:
    ...
    def merge(self, others, merge_body="default") -> None:
        ...
        if type(others) is not list:
            others = [others]
        for _idx, other in enumerate(others):
            if not isinstance(other, MujocoXML):
                raise XMLError(f"{type(other)} is not a MujocoXML instance.")
    ...
    def save_model(self, fname, pretty=False) -> None:
    ...
    def merge_assets(self, other) -> None:
    ...
    def _replace_defaults_inline(self, default_dic, root=None) -> None:
...
class MujocoModel:
    ...
    def set_sites_visibility(self, sim, visible) -> None:
    ...
    def exclude_from_prefixing(self, inp) -> Never:
    ...
    @property
    def important_geoms(self) -> Never:
    ...
    @property
    def important_sites(self) -> Never:
    ...
    @property
    def important_sensors(self) -> Never:
    ...
    @property
    def horizontal_radius(self) -> Never:
...
class MujocoXMLModel(MujocoXML, MujocoModel):
    ...
    def __init__(self, fname, idn=0) -> None:
    ...
    def exclude_from_prefixing(self, inp) -> bool:
    ...
    @property
    def name(self) -> str:
        return f"{type(self).__name__}{self.idn}"
    ...
    @property
    def _important_sites(self) -> Never:
        """Dict of sites corresponding to the important site geoms (e.g.: used to aid visualization during sim).
    ...
    @property
    def _important_geoms(self) -> Never:
        """Geoms corresponding to important components of this model. String keywords should be mapped to lists of geoms.
    ...
    @property
    def _important_sensors(self) -> Never:
        """Dict of important sensors enabled for this model.
    ...
    @property
    def contact_geom_rgba(self) -> Never:
