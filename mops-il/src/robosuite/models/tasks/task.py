...
class Task(MujocoWorldBase):
    ...
    def merge_robot(self, mujoco_robot) -> None:
    ...
    def merge_arena(self, mujoco_arena) -> None:
    ...
    def merge_objects(self, mujoco_objects) -> None:
        ...
        for mujoco_obj in mujoco_objects:
            ...
            assert isinstance(mujoco_obj, MujocoObject), (
                f"Tried to merge non-MujocoObject! Got type: {type(mujoco_obj)}"
            )
            # Merge this object
    ...
    def generate_id_mappings(self, sim) -> None:
        ...
        models = list(self.mujoco_objects)
        ...
        for model in models:
            ...
            for ids, group_type, ids_to_inst, ids_to_cls in zip(
                id_groups, group_types, ids_to_instances, ids_to_classes, strict=False
            ):
                # Add geom, site ids
