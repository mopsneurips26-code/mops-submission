...
class OperationalSpaceController(Controller):
    ...
    def __init__(
        ...
        **kwargs,  # does nothing; used so no error raised when dict is passed with extra terms used previously
        ...
        assert impedance_mode in IMPEDANCE_MODES, (
            ...
            f"impedance mode! Inputted impedance mode: {impedance_mode}, Supported modes: {IMPEDANCE_MODES}"
        )
    ...
    def update_origin(self, origin_pos, origin_ori) -> None:
    ...
    def update_initial_joints(self, initial_joints) -> None:
    ...
    def set_goal_update_mode(self, goal_update_mode) -> None:
        self._goal_update_mode = goal_update_mode

    def reset_goal(self, goal_update_mode="achieved") -> None:
