...
class InverseKinematicsController(JointPositionController):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert robot_name in SUPPORTED_IK_ROBOTS, (
            ...
            f"Inputted robot: {robot_name}, Supported robots: {SUPPORTED_IK_ROBOTS}"
        )
    ...
    def compute_joint_positions(
        ...
        Kn: np.ndarray | None = np.array([10.0, 10.0, 10.0, 10.0, 5.0, 5.0, 5.0]),
    ...
    def set_goal(self, delta, set_ik=None) -> None:
