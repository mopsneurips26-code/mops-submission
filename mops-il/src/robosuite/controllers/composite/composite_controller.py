...
class CompositeController:
    ...
    def load_controller_config(
        ...
        composite_controller_specific_config: dict | None = None,
    ) -> None:
    ...
    def _init_controllers(self) -> None:
        for part_name in self.part_controller_config:
    ...
    def setup_action_split_idx(self) -> None:
        previous_idx = 0
        last_idx = 0
    ...
    def set_goal(self, all_action) -> None:
        for part_name, controller in self.part_controllers.items():
    ...
    def reset(self) -> None:
        for _part_name, controller in self.part_controllers.items():
    ...
    def set_goal(self, all_action) -> None:
        ...
        for part_name, controller in self.part_controllers.items():
            ...
            if part_name in self.arms and hasattr(controller, "set_goal_update_mode"):
                ...
                """
                action_mode = all_action[-1]
                goal_update_mode = "desired" if action_mode > 0 else "achieved"
...
class WholeBody(CompositeController):
    ...
    def _init_joint_action_policy(self) -> Never:
    ...
    def setup_whole_body_controller_action_split_idx(self) -> None:
    ...
    def print_action_info_dict(self, name: str = "") -> None:
        info_dict = {}
