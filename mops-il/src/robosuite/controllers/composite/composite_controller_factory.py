...
def validate_composite_controller_config(config: dict) -> None:
...
def load_composite_controller_config(
    controller: str | None = None, robot: str | None = None
) -> dict | None:
    ...
    try:
        ...
        ROBOSUITE_DEFAULT_LOGGER.info(
            f"Loading controller configuration from: {controller_fpath}"
        )
